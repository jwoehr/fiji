...
public class FIJIGui extends Object implements Runnable {
     ...
     *
     * @return <CODE>true</CODE> means that it's okay to call System.exit() on
     * closing the last FIJIFrame.
     */
    ...
    /**
     * Set true, a close of the session will invoke System.exit() when the last
     * FIJIFrame closes.
     *
     * @param yesNo If <CODE>false</CODE> then closing the last FIJIFrame will
     * not explicitly call System.exit(0);
     */
     ...
     *
     * @return <CODE>true</CODE> if file loaded okay, <CODE>false</CODE>
     * otherwise.
     */
