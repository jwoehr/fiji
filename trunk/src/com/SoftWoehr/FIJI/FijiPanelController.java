...
/**
 * The controller for the FijiPanel. This controller provides methods called by
 * events, and also interaction with application controller.
 *
 * @author jax
 * @version $Id: FijiPanelController.java,v 1.2 2016-11-15 13:42:00 jwoehr Exp $
 */
public class FijiPanelController extends Object {
     ...
     */
    protected final void set_application_controller(FIJIGui fg) {
     ...
     */
    protected final void get_properties() {
     ...
     */
    public final void set_frame(FijiFrame frame) {
        my_frame = frame;
    }
     ...
     */
    public final FijiPanel get_panel() {
        return my_panel;
    }
     ...
     */
    public final void set_panel(FijiPanel fp) {
        my_panel = fp;
    }
    ...
    //////////
    /**
     * Get pathname for a save or for an open of some text area stuff or return
     * null
     *
    ...
    protected String doSaveOpenTextDialog(boolean saveNotOpen) {
        ...
        ChooseFile cf = new ChooseFile(my_current_text_path,
    ...
    protected String doLoadFijiDialog() {
        ...
        // Create dialog with user.
        ChooseFile cf = new ChooseFile(my_current_source_path,
