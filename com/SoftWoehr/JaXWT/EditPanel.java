 ...
 *
 * @author  jax
 * @version $Id: EditPanel.java,v 1.3 2001-09-16 04:27:07 jwoehr Exp $
 */
public class EditPanel extends javax.swing.JPanel implements FindAndReplaceServer {
   ...
   * @param changed_NOT <CODE>true</CODE> iff changed
   */
   ...
   * @param s String sought String sought
   ...
   * @return the filer used to file text.
   */
  ...
  /** Get the associated text filer
   * @param t the filer used to file text.
   */
   ...
   * @param encoding Char encoding to use.
   ...
   * @param f File to open.
   * @param encoding Char encoding to use.
   * @param position offset if insert
   * @return <CODE>true</CODE> iff inserted
   */
   ...
   * @param f file to open
   * @param encoding char encoding to use
   * @return true if opened and inserted.
   */
   ...
   * @param f file to open
   * @param encoding char encoding to use
   * @param position offset to insert at.
   * @return true if opened and inserted.
   */
