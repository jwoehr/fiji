...
/**
 * An input box to allow command-line input into FIJI interpreter. Each line is
 * parsed, echoed in the text window and executed with results to the text
 * window. It's also saved in the dropdown so that if the user makes a selection
...
public class FijiInputComboBox extends JComboBox {
    ...
    /**
     * Respond to either a selection or an ENTER in the edit box All this does
     * is push the input line down if it's non-blank. Interpretation happens in
     * an outer listener in FijiInputPanel.
     *
