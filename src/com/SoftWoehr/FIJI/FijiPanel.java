...
/**
 * The panel which contains the whole FIJI Gui layout. Controlled by its
 * FijiPanelController, it fits right in the FijiFrame.
 *
 * @author jax
 * @version $Id: FijiPanel.java,v 1.2 2016-11-15 15:20:22 jwoehr Exp $
 */
public class FijiPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FijiPanel. This ctor only useful for the design editor
     * which needs a zero-arity ctor at design time.
     */
    public FijiPanel() {
        this(null, null);
    }
