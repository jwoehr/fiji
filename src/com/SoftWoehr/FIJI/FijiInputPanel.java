...
/**
 * An input panel with a clear button, a drop-down history and an Interpret
 * button.
 *
 * @author jax
 * @version $Id: FijiInputPanel.java,v 1.2 2016-11-15 16:06:01 jwoehr Exp $
 */
public class FijiInputPanel extends javax.swing.JPanel {
     ...
     * @param fpc The associated panel controller
     */
    protected final void set_controller(FijiPanelController fpc) {
        my_controller = fpc;
    }
  ...
  private void interpretButtonActionPerformed (java.awt.event.ActionEvent evt) {//GEN-FIRST:event_interpretButtonActionPerformed
      ...
      interpret_input();
      fijiInputComboBox.getEditor().selectAll();
