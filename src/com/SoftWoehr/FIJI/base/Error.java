...
public class Error extends java.lang.Error implements SoftWoehr, verbose {
     ...
     * Revision level
     */
    private static final String RCSID = "$Id: Error.java,v 1.2 2016-11-06 21:29:07 jwoehr Exp $";
    ...
    public static class desktop {
        ...
        public static class shell {
            ...
            public static class CompileToValue extends com.SoftWoehr.FIJI.base.Error {
                 ...
                 * Arity/1 Throwable constructor.
                 *
                 * @param t The throwable to carry along The throwable to carry
                 * along
                 */
 ...
 /* GPL'ed SoftWoehr announces itself. */
        System.out.println("Error, Copyright (C) 1998, 2016 Jack J. Woehr.");
        ...
        GetArgs.main(argv);
        // -------------------
        /* Delete this stub when you write some code.*/
    }
}
/* End of Error class*/
