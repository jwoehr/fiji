...
public class BinDump implements SoftWoehr {
    ...
    private static final String rcsid = "$Id: BinDump.java,v 1.1 2016-11-06 21:20:42 jwoehr Exp $";
     ...
     * and <code>System.out</code>
     * @param anInputStream The input stream to dump.
     */
     ...
     * @param anInputStream The input stream to dump.
     * @param anOutputStream The output stream to dump on.
     */
    public BinDump(InputStream anInputStream
     ...
     * discarded for garbage collection.</b>
     * @exception IOException On close error.
     */
     ...
     * @exception IOException On reset error.
     */
     ...
     * @return <CODE>true</CODE> .iff supports mark/reset.
     */
     ...
     * @param upperNotUpper <CODE>true</CODE> if uppercase output is desired, <CODE>false</CODE> otherwise.
     */
     ...
     * @return Return true if uppercase output, false otherwise.
     */
     ...
     * @return String result of entire dump.
     */
     ...
     * @throws EOFException on end-of-file error
     ...
     * @param argv Arguments to test encapsulated in main().
     */
