...
class UnsignedByte extends Number implements SoftWoehr {
     ...
     */
    private static final String rcsid = "$Id: UnsignedByte.java,v 1.2 2016-11-08 01:10:09 jwoehr Exp $";
    ...
    /**
     * Construct an UnsignedByte from a string. Uses
     * <code>Integer.parseInt()</code> to conform to the behaviour of the
     * <code>Integer(String)</code> and <code>Byte(String)</code>. The other
    ...
    /**
     * Return a new String object representing the object's value in radix 10 as
     * an unsigned byte.
     *
    ...
    /**
     * Return a new String object representing the object's value in radix
     * <I>radix</I>.
     *
     * @param i The int to string-ize.
    ...
    /**
     * Decodes a String into an UnsignedByte. The String may represent decimal,
    ...
    public static UnsignedByte decode(String s) {
        return new UnsignedByte(Integer.decode(s));
    }

    /**
     * Assuming the specified String represents an UnsignedByte,, returns a new
     * UnsignedByte object initialized to that value. Throws an exception if the
     * String cannot be parsed as an UnsignedByte.
     *
